  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative">
        <div className="relative">
          <ImageCarousel />
          {/* O degradê agora NÃO interfere nos elementos interativos */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-transparent pointer-events-none z-10"></div>
        </div>

        {/* Texto do Carrossel agora está acima de tudo (z-30) */}
      ...
      {/* Botão de Voltar ao Topo - Agora clicável */}
      {showScrollTop && (
        <button
