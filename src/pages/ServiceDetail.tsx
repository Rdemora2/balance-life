...
const services = {
  slackline: {
    title: 'Slackline',
    icon: Activity,
    description: 'O slackline é uma prática que desenvolve equilíbrio, força e concentração. Através de uma fita elástica tensionada entre dois pontos, os praticantes aprendem a caminhar e realizar manobras, desenvolvendo habilidades físicas e mentais.',
    benefits: [
  ...
  'balance-board': {
    title: 'Balance Board',
    icon: Users,
    description: 'O treinamento com balance board é uma excelente forma de desenvolver equilíbrio, propriocepção e força core. Ideal para preparação física, reabilitação e melhoria do desempenho esportivo.',
    benefits: [
  ...
  parkour: {
    title: 'Parkour',
    icon: Award,
    description: 'O parkour é uma disciplina que ensina a superar obstáculos de forma eficiente e segura. Através de movimentos naturais como correr, saltar e escalar, os praticantes desenvolvem força, agilidade e autoconfiança.',
    benefits: [
  ...
  eventos: {
    ...
    icon: Calendar,
    description: 'Oferecemos serviços de recreação para diversos tipos de eventos, com atividades adaptadas ao perfil do público e espaço disponível. Ideal para eventos corporativos, festas e encontros.',
    benefits: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="prose prose-lg max-w-none">
            ...
            {service.levels && (
              <>
                <h2 className="text-2xl font-bold mb-4">Níveis de Treinamento</h2>
                <ul className="mb-8">
                  {service.levels.map((level, index) => (
                    <li key={index} className="mb-2">{level}</li>
                  ))}
                </ul>
              </>
            )}
